      ...
      <div ref={ref} className="lg:w-[84%] md:h-[40rem] sm:h-[30rem] flex lg:justify-center md:justify-center sm:justify-start relative items-start md:mb-8 sm:mb-4">
        ...
        <div className="relative w-[78%] h-full grid grid-cols-2 gap-10 lg:left-36">
          <motion.div
            ...
            <h2 className="font-bold md:text-base sm:text-sm">Suspect/Criminal</h2>
            <h2 className="font-bold md:text-base sm:text-sm">Management System</h2>
            <div className="mt-6 mb-8 text-[#727171] md:text-lg sm:text-base sm:line-clamp-6 md:line-clamp-none">
            pakPOL is an advanced and intelligent criminal management system designed to transform and revolutionize the way law enforcement agencies in Pakistan, including provincial and local police departments, manage, respond to, and analyze criminal data. This system is particularly focused on enhancing the efficiency and accuracy of searching for records related to criminal activities, tasks, and investigations.
            </div>
{/* {            <a
