    ...
    <section className="xl:h-full lg:h-full exactly-1024:h-fit pt-9 md:pb-28 sm:pb-20 relative z-0" id="contact-section">
      ...
      <div>
        <div className="flex flex-col mb-6 mt-10">
          <div>
            <Reveal RevealDelay={0.6} TextDelay={0.89}><h1 className="text-5xl font-bold">Let's unite.</h1></Reveal>
            <Reveal RevealDelay={0.6} TextDelay={0.89}><h1 className="text-5xl font-bold mb-5">Give us your opinions as well.</h1></Reveal>
            <Reveal RevealDelay={0.6} TextDelay={0.89}>
              <p className="font-second-font text-fifth-color">
                We are open to any form of constructive criticism which can help us grow more.
              </p>
            </Reveal>
            <Reveal RevealDelay={0.6} TextDelay={0.89}>
              <p className="font-second-font text-fifth-color">
               Your opinion would mean a lot please, don't hesitate to contact us.
              </p>
            </Reveal>
          </div>
